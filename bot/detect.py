...
MODEL = os.path.join(ROOT_DIR, 'yolov7-tiny_480x640.onnx')

CLASSES = list(map(lambda x: x.strip(), open(os.path.join(os.path.dirname(__file__), 'coco.names'), 'r').readlines()))
